        ...
        <div className="text-center text-white">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-sm opacity-90">We visit with you in your home to understand your needs</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white text-mariposa-green rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl">
                2
              ...
              <p className="text-sm opacity-90">We work together to understand your goals and scheduling</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white text-mariposa-green rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl">
                3
              ...
              <p className="text-sm opacity-90">Our matchmaking process connects you with an ideal caregiver</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white text-mariposa-green rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl">
                4
              ...
              <p className="text-sm opacity-90">Regular check-ins to ensure you receive the best possible care</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 rounded-2xl p-8 mb-8 backdrop-blur-sm">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold">(612) 400-4532</p>
                <p className="opacity-90">Talk to one of our support team members</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-mariposa-orange rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-xl font-semibold">www.mariposahomecare.com</p>
