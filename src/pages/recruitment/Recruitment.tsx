...
const Recruitment = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-mariposa-green to-green-600 text-white py-20 pt-32">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-mariposa-navy to-blue-900 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg
                  className="w-10 h-10 text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-mariposa-green to-green-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg
              ...
              <Link
                to="/contact"
                className="block w-full bg-mariposa-green text-white text-center py-3 rounded-full font-semibold hover:bg-green-600 transition-colors"
              >
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-mariposa-orange to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg
                    className="w-8 h-8 text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
              ...
              <Link
                to="/contact"
                className="block w-full bg-mariposa-orange text-white text-center py-3 rounded-full font-semibold hover:bg-orange-600 transition-colors"
              >
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-mariposa-navy to-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg
                    className="w-8 h-8 text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
              ...
              <Link
                to="/contact"
                className="block w-full bg-mariposa-navy text-white text-center py-3 rounded-full font-semibold hover:bg-blue-900 transition-colors"
              >
                Apply to Volunteer
              </Link>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-mariposa-green rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl text-white">
                1
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-mariposa-orange rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl text-white">
                2
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-mariposa-navy rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl text-white">
                3
              </div>
